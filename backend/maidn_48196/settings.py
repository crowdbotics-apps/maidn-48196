"""
Django settings for maidn_48196 project.
...
WSGI_APPLICATION = 'maidn_48196.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "maidn_48196 API",
    "DESCRIPTION": "API documentation for maidn_48196 App",
    "VERSION": "v1",
}
